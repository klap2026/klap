...
export function Button({
  ...
  const variants = {
    primary: 'bg-accent-orange text-white hover:bg-orange-600 shadow-lg shadow-orange-200',
    secondary: 'bg-primary-navy text-white hover:bg-blue-900 shadow-lg shadow-blue-200',
